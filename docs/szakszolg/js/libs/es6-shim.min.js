...
;(function (e, t) {
    ...
    var jr = Math.round
    var Sr = Math.round(0.5 - Number.EPSILON / 4) === 0 && Math.round(-0.5 + Number.EPSILON / 3.99) === 1
    var Tr = lr + 1
    var Ir = 2 * lr - 1
            ...
            Map: (function () {
                ...
                var o = function requireMapSlot(e, t) {
                    if (!re.TypeIsObject(e) || !n(e)) {
                        throw new TypeError(
                            'Method Map.prototype.' + t + ' called on incompatible receiver ' + re.ToString(e),
                        )
                    }
                }
            ...
            Set: (function () {
                ...
                b(i.prototype, {
                    ...
                    clear: function clear() {
                        ...
                        if (this['[[SetData]]']) {
                            this['[[SetData]]'].clear(searchInput)
                        }
                    },
                    values: function values() {
                        r(this, 'values')
