...
@NgModule({
    declarations: [HeaderComponent, JoinPipe, AnswerChooseComponent, AnswerFreeAnswerComponent],
    ...
    exports: [HeaderComponent, JoinPipe, AnswerChooseComponent, AnswerFreeAnswerComponent],
})
